...
# === 頁面 3: 訂單與媒合 (OMS) ===
    ...
    tab_orders, tab_subs, tab_history, tab_progress = st.tabs(["🚚 出貨排程與媒合", "👥 訂戶與合約管理", "📜 已配貨訂單查詢", "📊 履約進度監控"])
                ...
                with top_col2:
                    ...
                    if current_selected:
                        ...
                        for idx_b, (_, row_b) in enumerate(target_orders.iterrows()):
                            ...
                            mock_url_bulk = f"https://mock-vege-system.com/portal?sub={row_b['subscription_id']}"
